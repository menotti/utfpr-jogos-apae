...
public class LifeUp extends GameObject {
    ...
    public LifeUp(int x, int y, int speedX, int speedY) {
        super();
        this.x = x;
        this.y = y;
        this.speedX = speedX;
        this.speedY = speedY;
        this.image = Util.loadImage(Global.IMG_LIFEUP);
    ...
    public void reset() {
        active = false;
        y = startY;
        activeDelay = rand.nextInt(Global.LIFEUP_DELAY * Global.speed) + 1200;
        if (Global.pista == 1){
