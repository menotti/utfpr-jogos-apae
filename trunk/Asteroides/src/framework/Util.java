...
public class Util {
    ...
    public static String formatSeconds(int seconds, int format) {
        switch(format) {
            case HOUR: return String.format("%02d:%02d:%02d", (seconds / SECONDS_PER_MINUTE) / MINUTES_PER_HOUR, seconds / SECONDS_PER_MINUTE, seconds % SECONDS_PER_MINUTE);
            case MINUTE: return String.format("%d:%02d", seconds / SECONDS_PER_MINUTE, seconds % SECONDS_PER_MINUTE);
            case SECOND: return String.format("%d", seconds);
            case MILISSECOND: return String.format("%d", seconds * MILISSECONDS_PER_SECOND);
            default: return "";
        }
    }
