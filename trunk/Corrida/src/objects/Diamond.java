...
public class Diamond extends GameObject {
    ...
    public Diamond(int x, int y, int speedX, int speedY) {
        super();
        this.x = x;
        this.y = y;
        this.speedX = speedX;
        this.speedY = speedY;
        this.image = Util.loadImage(Global.IMG_SCOREUP);
    ...
    public void reset() {
        active = false;
        y = startY;
        activeDelay = rand.nextInt(Global.DIAMOND_DELAY * Global.speed)+800+(Global.DIAMOND_DELAY * Global.level);
        if (Global.pista == 1){
