 ...
 * @author Luiz Philipe
 */
public class GameMenuOptions extends Screen implements MenuListener {

    Menu menu;
    String itens[] = {Internacionalization.get("som"),
    ...
    public GameMenuOptions() {
        ...
        menu = new Menu(370, 280, itens, Global.MENU_FONT, this);
    ...
    public void menuAction(int menuIndex) {
        switch (menuIndex){
            case 0:
                Screen.setCurrentScreen(new GameMenuOptionsSound());
                break;
            case 1:
                Screen.setCurrentScreen(new GameMenuLanguage());
                break;
            case 2:
