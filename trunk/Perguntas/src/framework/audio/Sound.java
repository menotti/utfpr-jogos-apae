...
public class Sound {
    ...
    /**
     * Toca um audio uma unica vez. Os formatos suportados sao: MID, MP3 e WAV.
     * Recebe como parametro o endereco do arquivo de audio.
     * @param file
     */
    ...
    /**
     * Toca o audio repetitivamente. Os formatos suportados sao: MID, MP3 e WAV.
     * Recebe como parametro o endereco do arquivo de audio.
     * @param file
     */
    ...
    public void play(String file, double seconds) {
        audioPlayer.setStopTime(new Time(seconds));
        play(file, false);
    }
     ...
     * @param loop
     */
    private void play(String file, boolean loop) {
        if (!enabled) {
            return;
        }
        ...
        try {
            ...
            audioPlayer.setVolumeLevel("5");
            System.out.println(" " + audioPlayer.getZoomTo());
            System.out.println(" " + audioPlayer.getVolumeLevel());
            audioPlayer.start();
            playing = true;
    ...
    /**
     * Retorna true se o player estiver ativo.
     * Caso contrario, se o player estiver desativado, retorna false.
     * 
     * @return
     */
    ...
    /**
     * Ativa ou desativa o player.
     * Quando o player esta desativado, nao e reproduzido o audio.
     *
     * @param enabled
     */
